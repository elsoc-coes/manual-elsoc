...
library(tidyverse)
library(kableExtra)
load(file = file.path('inputs', 'ELSOC_Long_2016_2022_v1.00_R.RData'))
...
atricion_sexo <-elsoc_long_2016_2022 %>%
  left_join(elsoc_long_2016_2022  %>% filter(ola == 1 & muestra == 1 | ola == 3 & muestra == 2) %>% 
...
atricion_edad <- elsoc_long_2016_2022 %>%
  left_join(elsoc_long_2016_2022 %>% filter((ola == 1 & muestra == 1) | (ola == 3 & muestra == 2)) %>% 
...
atricion_educ <- elsoc_long_2016_2022 %>%
  left_join(elsoc_long_2016_2022 %>% filter(ola == 1 & muestra == 1 | ola == 3 & muestra == 2) %>% 
