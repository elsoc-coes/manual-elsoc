--- 
title: "Manual Metodológico ELSOC 2016-2023"
author: "Equipo ELSOC"
...
description: "Manual Metodológico ELSOC 2016-2023"
...
items_olas_modulos %>% 
  ...
  kbl(caption = 'Número de ítems por  módulo, según muestra y ola',
      ...
      booktabs = TRUE,
      col.name = c('Módulo', '2016', '2017', '2018', '2019', '2021', '2022','2023')) %>% 
  kable_styling(full_width = FALSE,
                latex_options = 'HOLD_position') %>% 
  kable_classic_2() %>% 
...
```{r graf-fechas-ola6, fig.cap = 'Número de entrevistas por semana, ola 2022'}
...
tasas_ola6 %>% 
  kbl(caption = 'Tasas de Respuesta, Cooperación, de Rechazo y de Contacto, ola 2022',
      align = c('l', 'c', 'c'),
      booktabs = TRUE,
      col.name = c('Indicador', 'Muestra Original', 'Muestra Refresco')) %>% 
  kable_styling(full_width = FALSE,
...
tasas_olas %>%
  select(-muestra) %>% 
  kbl(caption = 'Tasas de Respuesta, de Cooperación, de Rechazo y de Contacto, según ola y muestra',
      align = c('c', 'c', 'c', 'c', 'c'),
      col.name = c('Ola', 'Tasa de Respuesta', 'Tasa de Cooperación', 'Tasa de Rechazo', 'Tasa de Contacto'),
      booktabs = TRUE) %>% 
  kable_styling(full_width = FALSE,
                latex_options = 'HOLD_position') %>% 
  kable_classic_2() %>% 
  pack_rows('Muestra Original', 1, 6) %>%
  pack_rows('Muestra Refresco', 7, 10)


```

### Implementación Ola 2023

El proceso de recolección de datos comenzó el viernes 11 de diciembre de 2023, con la asignación de la muestra a los encuestadores capacitados y seleccionados para el estudio, después de completar el proceso de reclutamiento y selección a nivel nacional. Este trabajo se extendió por un período de 21 semanas, finalizando el 20 de mayo de 2024 (ver Figura \@ref(fig:graf-fechas-ola6)).

Como resultado, el Plebiscito Constitucional de Salida 2023 ocurrió durante el proceso de recolección de datos (realizado el domingo 17 de diciembre), lo que requirió actualizar las preguntas del cuestionario relacionadas con el plebiscito. En particular, se modificó la pregunta sobre el plebiscito, eliminando la que hacía referencia a la intención de voto y añadiendo, en cambio, dos nuevas preguntas: la primera se refiere a si la persona participó en la votación del plebiscito, y la segunda al voto retrospectivo en cuestión.

```{r graf-fechas-ola6, fig.cap = 'Número de entrevistas por semana, ola 2023'}
...
tasas_ola7 %>% 
  kbl(caption = 'Tasas de Respuesta, Cooperación, de Rechazo y de Contacto, ola 2023',
      align = c('l', 'c', 'c'),
      booktabs = TRUE,
      col.name = c('Indicador', 'Muestra Original', 'Muestra Refresco')) %>% 
  kable_styling(full_width = FALSE,
...
tasas_olas %>%
  ...
  kable_styling(full_width = FALSE,
                latex_options = 'HOLD_position') %>% 
  kable_classic_2() %>% 
  pack_rows('Muestra Original', 1, 7) %>%
  pack_rows('Muestra Refresco', 8, 12)
...
En este apartado se presenta la Ficha Técnica (Ver Cuadro \@ref(tab:ficha), d��nde se sintetizan las principales características del Estudio Longitudinal Social de Chile (ELSOC COES):
...
En caso de que detecte problemas con la base de datos, desee plantear solicitudes y/o tenga dudas sobre aspectos no cubiertos por el presente Manual de Usuario, las cuales no puedan ser resueltas por otros medios, puede comunicarse con el Equipo de Encuestas COES al correo electrónico [elsoc@uc.cl](elsoc@uc.cl). El equipo procesará su solicitud y tratará de contestar en el más breve plazo.
