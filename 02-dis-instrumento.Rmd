...
En segundo lugar, y encadenado con lo anterior, se ajustaron las variables que teniendo más de 5 categorías de respuesta generaban mayores complicaciones para preguntar en las pruebas pilotos de esta encuesta. A continuación, se presentan los ítems que fueron reducidos en sus alternativas de respuesta y el criterio que se adoptó para cada caso:
 ...
 ### Cuestionario 2022: Método Mix-mode {-#mixmode}
 
A diferencia de olas anteriores, en la sexta ola se utiliza el método **mix-mode** o metodología **mixta** combinando los formatos CAPI y CATI para realizar las encuestas, optimizando así el proceso de levantamiento.

La evidencia en general indica que este formato aumenta la cobertura, y reduce los errores de medición (Dillman et al., 2014), así como menores sesgos de representación de personas de menores ingresos y con mayores privaciones materiales (Lipps, 2016), razones por las cuales múltiples encuestadoras están optando por esta nueva modalidad.

Otros estudios muestran que no hay diferencias significativas en el grado de confianza y en la estabilidad de las estimaciones al comparar los métodos de recolección CAPI con Mixtos (Cernat, 2015). En cuanto a las tasas de no respuesta, Lynn et al. (2010), tras realizar un experimento aleatorizado, encuentra que los diseños de modo mixto no fueron capaces de igualar la tasa de respuesta lograda por el diseño unimodal cara a cara. A esta investigación se suma una posterior realizada por Bianchi, Biffignandi y Lynn (2016) donde concluyen que la elección del método no hace una diferencia en cuanto a la proporción de personas que participan o las características de las personas que participan.

Dado la evidencia previa, se puede considerar que no hay diferencias en confianza ni estabilidad entre los modelos mixtos, además que no se debería esperar una diferencia en la proporción de participantes o las características de quienes deciden participar. Por el contrario, este nuevo diseño podría permitir disminuir el sesgo de representación y ser un aporte para las próximas olas de ELSOC.


## Listado de variables

Dada la gran cantidad de ítems medidos en el tiempo, para examinar de manera detallada las diferencias entre los instrumentos aplicados, se sugiere a los interesados revisar los **Cuestionarios** de cada medición. De igual forma, se sugiere revisar el [**Listado de variables**](https://coes.cl/wp-content/uploads/Listado-de-Variables-ELSOC-2.xlsx) y el [**Libro de Códigos**](#libro-codigos), donde se incluyen todos los ítems medidos en ELSOC, con información detallada sobre las olas en que fueron medidas cada pregunta, así como las modificaciones y otras informaciones relevantes para el uso de los datos ELSOC.
